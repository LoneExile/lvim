...
local mode_map = {
	...
	["noCTRL-V"] = {
		"#DCDCAA",
		"Operator-pending (forced blockwise |o_CTRL-V|) CTRL-V is one character",
	},
...
ins_left({
	...
	symbols = {
		added = icons["gitadd"],
		modified = icons["gitmod"],
		removed = icons["gitdel"],
	},
	diff_color = {
...
ins_right({
	function()
		...
		local icon =
			require("nvim-web-devicons").get_icon(filename, fileext, { default = true })
